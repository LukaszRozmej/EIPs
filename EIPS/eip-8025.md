...
The block-level access list of [EIP-7928](./eip-7928.md) is the case to watch,
because it is order-sensitive and is typically assembled from the same
read/write tracking that populates those containers.
